    ...
    <div class="container">
        <div class="row g-5 justify-content-center mb-5">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="bg-light text-center h-100 p-5">
                    <div class="btn-square bg-white rounded-circle mx-auto mb-4" style="width: 90px; height: 90px;">
                        <i class="fa fa-phone-alt fa-2x text-primary con-icon"></i>
                    </div>
                    <h4 class="mb-3">Phone Number</h4>
                    <p class="mb-2">+91 742 888 11150</p>
                    <p class="mb-4">+91 742 888 11150</p>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="bg-light text-center h-100 p-5">
                    <div class="btn-square bg-white rounded-circle mx-auto mb-4" style="width: 90px; height: 90px;">
                        <i class="fa fa-envelope-open fa-2x text-primary con-icon"></i>
                    </div>
                    <h4 class="mb-3">Email Address</h4>
                    <p class="mb-2">cs@xpressbuddy.in</p>
                    <p class="mb-4">support@example.com</p>
                    <a class="btn btn-primary px-4" href="mailto:cs@xpressbuddy.in">Email Now <i class="fa fa-arrow-right ms-2"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="bg-light text-center h-100 p-5">
                    <div class="btn-square bg-white rounded-circle mx-auto mb-4" style="width: 90px; height: 90px;">
                        <i class="fa fa-map-marker-alt fa-2x text-primary con-icon"></i>
                    </div>
        ...
        <div class="row mb-5">
            <div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
                <iframe class="w-100" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3770.026265223126!2d72.88627027521065!3d19.106503651014197!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c872f12edf37%3A0x4487184ecba560b!2sGundecha%20Onclave!5e0!3m2!1sen!2sin!4v1694677446210!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="row g-4">
                    <div class="col-6">
                        <div class="d-flex">
                            <div class="flex-shrink-0 btn-square bg-primary rounded-circle con-icon">
                                <i class="fa fa-phone-alt text-white"></i>
                            </div>
                            <div class="ms-3">
                                <h6>Call Us</h6>
                                <span>+91 742 888 11150</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                <form  action="contactEnquiry.php" method="post">
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                <div class="g-recaptcha" data-sitekey="6Ldx4BknAAAAAF8-JjKFkUzc9zYzNqvWWPYQ_Y3v"></div>
                            </div>
                        </div>
                        <div class="col-12">
