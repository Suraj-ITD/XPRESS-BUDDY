    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <p class="mb-4">Xpress Buddy, a unit of ZPD Solutions LLP, is a leading express courier and cargo services company with professional management
                    team having more than 15 years of experience in Supply Chain Management, International Logistics Business, Custom Regulations,
                    Domestic Transportation and Integrated Logistics Solution.</p>

                <p class="mb-4">We offer end-to-end logistis solutions on international express courier and cargo services, and we currently having offices at Hyderabad,
                    New Delhi and Mumbai in addition to a network of Agents Warehouses Worldwide. We proudly announce that we are capable of handling any
                    kind of jobs on a domestic and international level.</p>

                <p class="mb-4">Justifiably, our successful growth has been attributed to a well-defined goal, strategic planning, dynamic leadership and a team of
                    self-motivated and well experienced professionals,
                    trained to give the best in ultimate customer satisfaction.</p>
                    ...
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <h5 class="mb-0">cs@xpressbuddy.in</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <h5 class="mb-0">+91 742 888 1115</h5>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                ...
                <p class="mb-4">Xpress Buddy is a leading express courier and cargo services company with professional management team having more than 10 years of experience in Supply Chain Management, International Logistics Business, Custom Regulations,
                    Domestic Transportation and Integrated Logistics Solution.
                </p>
                <div class="row gy-4">
                    <!-- <div class="col-12">
                            <div class="d-flex">
        ...
        <div class="row gy-5 gx-4">
            <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item">
                    <img class="img-fluid" src="img/services-1.jpg" alt="">
                    ...
                    <div class="service-detail">
                        <div class="service-title">
                            <hr class="w-25">
                            <h3 class="mb-0">Express Worldwide Door To Door Service</h3>
                            <hr class="w-25">
                        </div>
                    ...
                    <a class="btn btn-light" href="service.php">Read More</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item">
                    ...
                    <div class="service-detail">
                        <div class="service-title">
                            <hr class="w-25">
                            <h3 class="mb-0">Express Services Import & Export</h3>
                            <hr class="w-25">
                        </div>
                        <div class="service-text">
                            <!-- <p class="text-white mb-0">Erat ipsum justo amet duo et elitr dolor, est duo duo eos
            ...
            <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item">
                    ...
                    <div class="service-detail">
                        <div class="service-title">
                            <hr class="w-25">
                            <h3 class="mb-0">Cargo Consolidation</h3>
                            <hr class="w-25">
                        </div>
                        <div class="service-text">
                            <!-- <p class="text-white mb-0">Erat ipsum justo amet duo et elitr dolor, est duo duo eos
